                ...
                $(document).ready(function()
                {
                    ...
                    $('#sub, #upd').click(function()
                    {
                        if ($(this).is('#sub')) 
                        {
                           ...
                           var cid=$('#cid').val();
                           var inputIds = ['#title', '#date', '#location','#desc'];
                        }
                ...
                function editEvent(button)
                 {
                    ...
                    var desc = closestTr.querySelector('td:nth-child(3)').textContent;
                    var location = closestTr.querySelector('td:nth-child(4)').textContent;
                    var date = closestTr.querySelector('td:nth-child(5)').textContent;
