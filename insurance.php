<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper" id="form1">
        ...
        <?php
            ...
            $cid = 0;
            $sql = "SELECT max(id) FROM insurance";
                ...
                $(document).ready(function()
                {
                    ...
                    $('#sub, #upd').click(function()
                    {
                        if ($(this).is('#sub')) 
                        {
                           ...
                           var cid=$('#cid').val();
                            var inputIds = ['#title', '#date','#todate','#mobile','#location','#desc','#attend'];
                        }
                        var title = $('#title').val();
                        var desc = $('#desc').val();
                ...
                function editEvent(button)
                 {
                    ...
                    var fdate = closestTr.querySelector('td:nth-child(6)').textContent;
                    var tdate = closestTr.querySelector('td:nth-child(7)').textContent;
                    var attend = closestTr.querySelector('td:nth-child(8)').textContent;
