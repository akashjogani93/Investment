    ...
    <?php $click="reg"; $fname=$mname=$lname=$mobile=$pan=$email=$address=$blood=$gender=$bank="";
        ...
        <script>
            ...
            $(document).ready(function()
            {
                ...
                //             $('.required-error').css("border", "1px solid red");

                //         }else
                //         {
                //             $('.required-error').css("border", "1px solid gray");
                //         }
                //     });
                // });
            });
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="group-form col-md-4">
                                    ...
                                    <input type="email" class=" col-sm-4 form-control form-control-sm" value="<?php echo $email;?>" name="email" id="email" placeholder="DarrellCThorton@rhyta.com">
                            ...
                            <div class="row">
                                ...
                                <div class="group-form col-md-4">
                                    ...
                                    <input type="text" class=" col-sm-4 form-control form-control-sm pan" name="pan" value="<?php echo $pan;?>" id="pan" placeholder="ABCTY1234D" required>
                            ...
                            <div class="row">
                                ...
                                <div class="group-form col-md-4">
                                    ...
                                    <input type="text" class="col-sm-4 form-control form-control-sm" value="<?php echo $account;?>" onInput="checku()" name="acc" id="acc" placeholder="12345678978" required maxlength="20">
                                    <div id="msg"></div>
                                </div>
                                <div class="group-form col-md-4">
                                ...
                                <div class="group-form col-md-4">
                                    <label for="inputEmail3" class="form_label">IFSC Code *</label>
                                        <input type="text" class="col-sm-4 form-control form-control-sm ifsc" value="<?php echo $ifsc;?>" name="ifsc" id="ifsc"
                                            placeholder="SBIN0005943" required>
